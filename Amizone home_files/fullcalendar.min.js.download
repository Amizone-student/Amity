...
! function(t, e) {
    ...
    return function(t) {
        ...
        }), p.watch("CourseCode", ["dateProfile"], function (t) {
                return this.CourseCode = this.computeTitle(t.dateProfile)
            }),
            p.watch("FacultyName", ["dateProfile"], function (t) {
                return this.FacultyName = this.computeTitle(t.dateProfile)
            }),
			p.watch("RoomNo", ["dateProfile"], function (t) {
			    return this.RoomNo = this.computeTitle(t.dateProfile)
			}),
			
			p.watch("AttndColor", ["dateProfile"], function (t) {
			    return this.AttndColor = this.computeTitle(t.dateProfile)
			}),
            p.watch("sType", ["dateProfile"], function (t) {
                return this.sType = this.computeTitle(t.dateProfile)
            }),
